...
**How to apply:** Keep the transition state explicit (`fadeOut`, `mounting`, `fadeIn`) and do not use exit-presence delays for menu-only HUD elements that must be absent from the carousel.