...
The detonation center is volumetric: faceted icosahedral core/halo volumes, a rotating wireframe energy shell, a nested compression torus, and a palette-matched local light. Avoid billboard-like center layers.
